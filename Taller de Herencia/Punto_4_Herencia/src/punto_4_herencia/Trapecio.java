...
public class Trapecio extends Cuadrilatero{
    ...
    public Trapecio(int Coordenada_X_A, int Coordenada_X_B, int Coordenada_X_C, int Coordenada_X_D, int Coordenada_Y_A, int Coordenada_Y_B, int Coordenada_Y_C, int Coordenada_Y_D) {
